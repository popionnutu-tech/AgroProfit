...
(function () {
  ...
  var RU_DICT = {
    ...
    "Anulează": "Отменить",
    "Descărcare": "Разгрузка",
    "Retur": "Возврат",
    "Câte kg se descarcă înapoi în": "Сколько кг разгружается обратно в",
    "locația de plecare": "место отгрузки",
    "Lasă valoarea completă pentru retur total.": "Оставьте полное значение для полного возврата.",
    "Cantitatea depășește cât s-a livrat": "Количество превышает отгруженное",
    "Descarcă marfa înapoi în stoc": "Разгрузить товар обратно на склад",
    "Operatiuni anulate si retururi": "Отменённые операции и возвраты",
    "Livrarea nu are marfă de descărcat.": "В отгрузке нет товара для разгрузки.",
    "Cantitatea trebuie să fie un număr mai mare ca zero.": "Количество должно быть числом больше нуля.",
    "Motivul este obligatoriu.": "Причина обязательна.",
    "Motivul returului (obligatoriu) — ex.: cumpărătorul a refuzat marfa:":
      "Причина возврата (обязательно) — напр.: покупатель отказался от товара:",
